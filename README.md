...
* **Key Metrics:**
    ...
    * **Emotion detection Model Training:** dataset from [Toronto emotional speech set (TESS)](https://www.kaggle.com/datasets/ejlok1/toronto-emotional-speech-set-tess)
